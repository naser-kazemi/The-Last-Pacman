...
public class PersonalMazePage extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        mainStage = stage;
        URL signUpPageAddress = getClass().getResource("/Sample/fxml/personal_maze_page.fxml");
    ...
    public void selectMap1(MouseEvent mouseEvent) {
        File file = new File("src/main/resources/sample/data/personalMaps/" + currentUser.getUsername() + "/map1.txt");
        if (file.exists()) {
            Pacman.mapFileName = "src/main/resources/sample/data/personalMaps/" + currentUser.getUsername() + "/map1.txt";
    ...
    public void selectMap2(MouseEvent mouseEvent) {
        File file = new File("src/main/resources/sample/data/personalMaps/" + currentUser.getUsername() + "/map2.txt");
        if (file.exists()) {
            Pacman.mapFileName = "src/main/resources/sample/data/personalMaps/" + currentUser.getUsername() + "/map2.txt";
            Pacman.isMapDefault = false;
            resultAlert = new Alert(Alert.AlertType.NONE, "Map selected!", ButtonType.OK);
        }
        else
    ...
    public void selectMap3(MouseEvent mouseEvent) {
        File file = new File("src/main/resources/sample/data/personalMaps/" + currentUser.getUsername() + "/map3.txt");
        if (file.exists()) {
            Pacman.mapFileName = "src/main/resources/sample/data/personalMaps/" + currentUser.getUsername() + "/map3.txt";
            Pacman.isMapDefault = false;
            resultAlert = new Alert(Alert.AlertType.NONE, "Map selected!", ButtonType.OK);
        }
        else
    ...
    public void selectMap4(MouseEvent mouseEvent) {
        File file = new File("src/main/resources/sample/data/personalMaps/" + currentUser.getUsername() + "/map4.txt");
        if (file.exists()) {
            Pacman.mapFileName = "src/main/resources/sample/data/personalMaps/" + currentUser.getUsername() + "/map4.txt";
            Pacman.isMapDefault = false;
            resultAlert = new Alert(Alert.AlertType.NONE, "Map selected!", ButtonType.OK);
        }
        else
    ...
    public void selectMap5(MouseEvent mouseEvent) {
        File file = new File("src/main/resources/sample/data/personalMaps/" + currentUser.getUsername() + "/map5.txt");
        if (file.exists()) {
            Pacman.mapFileName = "src/main/resources/sample/data/personalMaps/" + currentUser.getUsername() + "/map5.txt";
            Pacman.isMapDefault = false;
            resultAlert = new Alert(Alert.AlertType.NONE, "Map selected!", ButtonType.OK);
        }
        else
